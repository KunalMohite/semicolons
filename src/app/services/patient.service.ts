...
export class PatientService {
  ...
  uploadAudioFile(file: File) {
    ...
    return this.http.post('https://c0a5-2402-e280-3e06-3f6-68fd-981-22f9-62cd.ngrok-free.app/transcribe', formData);
  }
  analyzeText(text: string): Observable<any> {
    return this.http.post<any>(`https://c0a5-2402-e280-3e06-3f6-68fd-981-22f9-62cd.ngrok-free.app/extract_data`, { text: text });
}
}